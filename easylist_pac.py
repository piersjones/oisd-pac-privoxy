...
# easylist_pac: Convert EasyList Tracker and Adblocking rules to an efficient Proxy Auto Configuration file (modified for OISD by Piers Wingfield)
...
#        self.download_list = [fanboy_antifacebook, fanboy_annoyance_url, easyprivacy_url, easylist_url] + self.extra_easylist_urls
        ...
        oisd = 'https://abp.oisd.nl/light'
        self.download_list = [oisd, easylist_antiadblock] + self.extra_easylist_urls
